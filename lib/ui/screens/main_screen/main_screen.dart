...
// import 'package:fleact_task/ui/screens/main_screen/main_screen_vm.dart';
// import 'package:fleact_task/ui/widgets/bottom_navbar_icon.dart';
...
//                         color: vm.selectedIndex == 0 ? AppColors.white : AppColors.mediumShade,
//                       ),
//                       kWidth(8.w),
//                       BottomNavbarIcon(
//                         onTap: () {
...
//                         color: vm.selectedIndex == 1 ? AppColors.white : AppColors.mediumShade,
//                       ),
//                       kWidth(8.w),
//                       BottomNavbarIcon(
//                         onTap: () {
...
//                         color: vm.selectedIndex == 2 ? AppColors.white : AppColors.mediumShade,
//                       ),
//                       kWidth(8.w),
//                       BottomNavbarIcon(
//                         onTap: () {
...
//                         color: vm.selectedIndex == 3 ? AppColors.white : AppColors.mediumShade,
//                       ),
//                     ],
//                   ),
//                 ),

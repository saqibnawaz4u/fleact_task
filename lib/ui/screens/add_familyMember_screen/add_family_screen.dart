...
class AddFamilyMemberScreen extends StatelessWidget {
  static const String routeName = '/add_family_screen';
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: ChangeNotifierProvider(
        create: (BuildContext context) => AddFamilyVm(),
        child: Consumer<AddFamilyVm>(
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          kHeight(2.h),
                          Text('Relation', style: textTheme.headlineSmall),
                          kHeight(2.h),
                          DefaultTextField(
                            controller: vm.relationC,
                            hintText: "Relation",
                            // validator: validateNameField,
                            keyboardType: TextInputType.name,
                            // inputFormatters: [
